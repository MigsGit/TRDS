...
class CreateQcSlipsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('qc_slips', function (Blueprint $table) {
            ...
            $table->string('status')->default('PB')->comment('1 PB-Preparedby | FORAPP- FORAPPROVAL | OK - CLOSED');
            $table->string('approval_status')->default('PB')->comment('look for op_approvers approval status');
