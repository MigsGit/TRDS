...
class CreateCQcCertificationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('c_qc_certifications', function (Blueprint $table) {
            ...
            $table->integer('first_sample_qcs_oper');
            $table->integer('first_ok_qcs_oper');
            $table->integer('first_ng_qcs_oper');
            $table->longText('qcs_station_1st_oper');
            $table->longText('obs_second_result_qcs_oper')->nullable();
            $table->integer('second_ok_qcs_oper')->nullable();
            $table->integer('second_sample_qcs_oper')->nullable();
            $table->integer('second_ng_qcs_oper')->nullable();
