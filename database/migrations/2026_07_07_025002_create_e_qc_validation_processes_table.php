...
class CreateEQcValidationProcessesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('e_qc_validation_processes', function (Blueprint $table) {
            ...
            $table->tinyInteger('vpqcs_oper')->comment('1 Production Abnormality Control | 2 Defect Escalation Procedure')->nullable();
            $table->tinyInteger('application_vpqcs_oper')->comment('1 Production Abnormality Control | 2 Applicable | 3 Not Applicable |')->nullable();
