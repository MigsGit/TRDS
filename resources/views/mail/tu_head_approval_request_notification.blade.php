...
<div class="container">
    ...
    </div> <div class="title"> Approve Training Request </div> <br> 
    <div class="text-center"> 
        <p style="font-size:14px; margin-bottom:10px;"> 
            Hi <strong>{{ $tuHeadRecipient }}</strong>, 
            {{-- Hi --}}
        </p> 
        <p style="font-size:14px; margin-bottom:10px;"> 
            Good day! 
        ...
        <p style="font-size:14px; margin-bottom:20px;"> 
            A new <strong>Training Request</strong> is awaiting your approval. 
            Please review the request details below and approve or reject the request through the Training Records Database System. 
        </p>
        <table class="details"> 
            <tr> 
                <td>
