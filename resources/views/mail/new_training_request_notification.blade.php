...
<div class="container">
    ...
    <div class="text-center">
        <b>
            <p style="font-size:12px;">
                Hi {{$recipientName  }}, you have a Training Request for Approval! See details below:
            </p>
        </b>
        ...
        <table class="details">
            ...
            <tr>
                <td><strong>HR Memo Document No.</strong></td>
                <td>{{ $documentNo }}</td>
            </tr>
            <tr>
    ...
    <div class="footer">
        <p class="text-center">
            <strong><em>If there are any concerns with this Training Request, call local 208.</em></strong>
        </p>
