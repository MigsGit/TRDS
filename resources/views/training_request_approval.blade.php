    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Training Request Approval</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card card-dark">
                            <div class="card-header">
                                <h3 class="card-title">Training Request Module</h3>
                            </div>

                            <!-- Start Page Content -->
                            <div class="card-body">
                                <div class="float-sm-right">
                                    <button class="btn btn-primary" id="btnShowModalRequestTraining">
                                        <i class="fa fa-plus fa-md me-2"></i> Request Training
                                    </button>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table id="tblTrainingRequest" class="table table-bordered table-striped table-hover" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 15%;"  class="text-center">Conformance</th>
                                                <th style="width: 15%;" class="text-center">Receiving</th>
                                                <th style="width: 15%;" class="text-center">TU Head Approval</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
            ...
            <div class="modal-content">
                ...
                <form method="post" id="formAddTrainingRequest" autocomplete="off">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="header">
                                <h5 class="text-info"><i class="fa fa-info-circle"></i> Memo Details</h5>
                            </div>
                        </div>
